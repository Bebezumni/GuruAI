...
class SalesAgentManager:
    ...
    def initialize_sales_agent(self, user_id):
        ...
        sales_agent = SalesGPT.from_llm(llm, use_tools=False,
                                        ...
                                        company_business='''Компания Inside Money - строит новую долину стартапов с развитой экосистемой в сердце Бали,мы предлагаем инвестиции в коммерческую недвижимость с высокой окупаемостью и офисные помещения с уникальной инфраструктурой на продажу для личного использования разного метража и бюджета, экосистема включает в себя рестораны, спорт зал, SPA, конференц-зал, баскетбольные площадки, вертолетные площадки и парковки, мы предоставляем автоматизированный роботами сервис создающий незабываемые впечатления у гостей. Инвестиции на бали это : рост ВВП выше 5%, рост земли в 4 раза за 6 лет, 7-я страна в мире по уровню экономического развития, Бали один из лидеров мировых туристических направлений''',
