...
class SalesAgentManager:
    ...
    def initialize_sales_agent(self, user_id):
        ...
        sales_agent = SalesGPT.from_llm(llm, use_tools=False,
                                        ...
                                        company_business='''Компания Inside Money - строит новую долину стартапов с развитой экосистемой в сердце Бали,Мы предлагаем инвестиции в коммерческую недвижимость с высокой окупаемостью и офисные помещения с уникальной инфраструктурой на продажу''',
                                        company_values='Создание высокодоходных инвестиционных условий в коммерческую недвижимость на Бали для своих партнеров и предоставление качественной офисной инфраструктуры на продажу',
